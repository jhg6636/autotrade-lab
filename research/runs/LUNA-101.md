...
| LUNA-101-02 | Draft sub-PR pending | 6 new source records / 6 hypotheses | 0 | 0 | Six public arXiv candidates appended; exact static rules were not exposed, so all remain incomplete |

## Preserved blockers and ambiguities

- Eighteen source records do not expose complete entry, exit, and sizing rules. They remain
