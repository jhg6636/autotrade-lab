"""Korea Investment & Securities adapter boundary.

Endpoint details intentionally remain behind a transport interface so tests never contact a
broker. Implement against the official KIS documentation, with `paper=True` as the default.
"""
